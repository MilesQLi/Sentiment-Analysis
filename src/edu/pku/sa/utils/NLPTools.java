 ...
 * 
 * dependency: Stanford segmenter,Stanford postagger
 * add a segmenterdata folder paste the files from Stanford segmenter's data folder.
 * 
 * paste models folder from Stanford postagger's models folder.
 *
 */
...
public class NLPTools {
	...
	private static final String basedir = System.getProperty("Whatever", "segmenterdata");
